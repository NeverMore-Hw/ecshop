...
function index_get_group_buy()
{
    ...
    if ($limit > 0)
    {
        $sql = 'SELECT gb.act_id AS group_buy_id, gb.goods_id, gb.ext_info, gb.goods_name, g.goods_thumb, g.goods_img, g.goods_middle ' .
        ...
        while ($row = $GLOBALS['db']->fetchRow($res))
        {
            ...
            $row['middle'] = get_image_path($row['goods_id'], $row['goods_middle'], true);
...
function index_get_auction()
{
    ...
    $sql = "SELECT a.act_id, a.goods_id, a.goods_name, a.ext_info, g.goods_thumb ,g.goods_middle ".
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
        ...
        $arr['middle'] = get_image_path($row['goods_id'], $row['goods_middle'], true);
