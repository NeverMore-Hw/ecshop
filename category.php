...
if (!$smarty->is_cached('category.dwt', $cache_id))
{
   ...
   $cate = get_categories_tree($cat_id);
...
foreach($goodslist as $key => $goods){
    ...
    $sql = 'SELECT img_id, img_desc, thumb_url, middle_url, img_url'.
       ' FROM ' .$ecs->table('goods_gallery').
       " WHERE goods_id = '$good_id' ORDER BY img_id";
...
function category_get_goods($children, $brand, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    $sql = 'SELECT g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ' .
                ...
                'g.promote_start_date, g.promote_end_date, g.goods_brief, g.goods_thumb , g.goods_middle, g.goods_img ' .
