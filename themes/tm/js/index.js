$(function(){
  ...
  $(".list").mouseover(function(){
     ...
     $(this).children(".list_head").children("div").css("background-image","url(./themes/tm/img/T1.png)");
  ...
  $(".list:even").mouseout(function(){
     ...
     $(this).children(".list_head").children("div").css("background-image","url(./themes/tm/img/T1bNnYXa4jXXcsI4sD-189-145.png)");
